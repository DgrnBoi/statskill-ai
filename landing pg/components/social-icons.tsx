...
export function LinkedinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM3 9h4v12H3V9Zm7 0h3.8v1.65h.05c.53-1 1.82-2.05 3.75-2.05C21.4 8.6 22 11.02 22 14.15V21h-4v-6.05c0-1.44-.03-3.3-2.01-3.3-2.02 0-2.33 1.57-2.33 3.19V21h-4V9Z" />
    </svg>
  )
}
