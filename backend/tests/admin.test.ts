...
describe('MoSPI Capacity Building & Admin Routes', () => {
  it('TC_ADMIN_001: GET /api/admin/divisions returns 200 with all 4 MoSPI divisions', async () => {
    ...
    expect(res.body.divisions.length).toBe(4);
  ...
  it('TC_ADMIN_003: GET /api/admin/acbp-dossier synthesizes official ACBP Dossier for CBC audit', async () => {
    ...
    expect(res.body.dossier.divisionAllocations.length).toBe(4);
